    ...
    <div>
      {/* Doctor Information */}
       ...
       <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        ...
        <button className='bg-[#5F6FFF] text-white my-6 text-sm font-light py-3 px-14 rounded-full hover:bg-[#4a5ce5] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50'>
          Book an appointment
        </button>
       </div> 
